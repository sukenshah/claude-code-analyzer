...
import type { ProjectDetail, ClaudeMdFile } from "../types.js";
...
export function ProjectPage() {
  ...
  // Derived before early returns so hooks are called unconditionally
        ...
        <table className="table">
          ...
          <tbody>
            {pagedSessions.map((s) => (
              <tr key={s.sessionId}>
                <td>
                  <Link to={`/session/${s.sessionId}`} className="link">
